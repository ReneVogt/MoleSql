...
I started by fighting my way through [Matt Warren's tutorial](https://blogs.msdn.microsoft.com/mattwar/2008/11/18/linq-building-an-iqueryable-provider-series/) and just implemented part X, _"GroupBy and Aggregates"_.  
At this point, Matt started converting his sample code into his [iqtoolkit](https://github.com/mattwar/iqtoolkit) project. And for me it's time to take a step back and look again:  
...
Oh, and before you call me [Bobby Tables](https://bobby-tables.com/): parameterization is already implemented. 
