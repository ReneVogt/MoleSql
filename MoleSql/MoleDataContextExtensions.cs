...
{
    /// <summary>
    /// Provides extension methods for the <see cref="MoleDataContext"/>.<br/>
    ...
    /// </summary>
    public static class MoleDataContextExtensions
    {
        /// <summary>
        ...
        /// <param name="context">The <see cref="MoleDataContext"/> this extension should work on.</param>
        ...
        public static IEnumerable<T> ExecuteQuery<T>([NotNull] this MoleDataContext context, string query, params object[] parameters)
        {
            if (context == null)
        ...
        public static IEnumerable ExecuteQuery([NotNull] this MoleDataContext context, string query, params object[] parameters)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static int ExecuteNonQuery([NotNull] this MoleDataContext context, string query, params object[] parameters)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
